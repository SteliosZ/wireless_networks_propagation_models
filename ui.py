...
class Ui_App(object):
    def setupUi(self, App):
        ...
        self.cost_321_rb = QtWidgets.QRadioButton(self.verticalLayoutWidget)
        self.cost_321_rb.setMinimumSize(QtCore.QSize(220, 23))
        self.cost_321_rb.setMaximumSize(QtCore.QSize(220, 23))
        self.cost_321_rb.setObjectName("cost_321_rb")
        self.verticalLayout.addWidget(self.cost_321_rb)
        self.cost_321_rb_2 = QtWidgets.QRadioButton(self.verticalLayoutWidget)
        self.cost_321_rb_2.setMinimumSize(QtCore.QSize(220, 23))
        self.cost_321_rb_2.setMaximumSize(QtCore.QSize(220, 23))
        self.cost_321_rb_2.setObjectName("cost_321_rb_2")
        self.verticalLayout.addWidget(self.cost_321_rb_2)
        ...
        self.openarea_rb = QtWidgets.QRadioButton(self.verticalWidget_2)
        self.openarea_rb.setMinimumSize(QtCore.QSize(139, 18))
        self.openarea_rb.setMaximumSize(QtCore.QSize(139, 18))
        self.openarea_rb.setObjectName("openarea_rb")
        self.verticalLayout_2.addWidget(self.openarea_rb)
        ...
        self.calc_outdoor_btn.setGeometry(QtCore.QRect(453, 496, 359, 25))
        ...
        self.calc_indoor_btn.setGeometry(QtCore.QRect(453, 496, 359, 25))
        ...
        self.tabs_area.setCurrentIndex(1)
    ...
    def retranslateUi(self, App):
        ...
        self.cost_321_rb.setText(_translate("App", "Cost 231"))
        self.cost_321_rb_2.setText(_translate("App", "Two - Ray"))
        ...
        self.openarea_rb.setText(_translate("App", "Open Area"))
        ...
        self.receiver_height_label.setText(_translate("App", "  Reciever Height (Htr)"))
        ...
        self.trans_height_label.setText(_translate("App", "  Transmitter Height (Htt)"))
